...
enum class MessageKeys(val default: String) {
    ...
    INVALID_SKIN_NAME("${ChatColor.RED}There is no skin named <skinname>, please try again."),
    WAND_SKIN_NOT_BOUGHT("${ChatColor.RED}Seems like you haven't bought out amazing skin <skinname> yet :("),
    CONFIGS_RELOADED("Configs were reloaded."),
    WAND_SKIN_IS_ALREADY_THAT("${ChatColor.RED}Your wand is already using skin <skinname>."),
